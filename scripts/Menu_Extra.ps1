...
function MainMenu {
	Init -Title $Version
	ShowMenu -VerCredit -Header "SAVE YOUR FILES!" -Description "This is the 'extra' version of CCStopper. After this prerelease, certian features in this version will be deprecated." -Options @(
		@{
			Name        = "Stop Processes"
